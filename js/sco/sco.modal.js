	...
	$.extend(Modal.prototype, {
		show: function() {
			...
			if (!this.$modal.length) {
				this.$modal = $('<div class="modal fade" id="' + this.options.target.substr(1) + '"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><a class="close" href="#" data-dismiss="modal">×</a><h4>&nbsp;</h4></div><div class="modal-body"/></div></div></div>').appendTo(this.options.appendTo).hide();
			}
